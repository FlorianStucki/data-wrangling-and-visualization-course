...
data_amp_performance_criteria <- data_amp_tidied|> 
  mutate(fast_trial = rt < 100, 1, 0) |> 
  group_by(unique_id) |> 
  summarize(percent_fast_trials = mean(fast_trial)*100) |> 
  mutate(exlude_amp_performance = ifelse(percent_fast_trials >10,"exclude","include"))
