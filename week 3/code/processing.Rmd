...
#Um alle möglichen EInträge zu sehen: Count(Variable)
#Die zwei zusammenfügen mit join

dat_age_gender <- full_join(dat_gender,dat_age, by = "unique_id")
#join_rigth,join_left etc.
