...
demographic_raw <- read.csv(file = "../data/raw/data_demographics_raw.csv") 
demographic_reshape <- demographic_raw |> 
  pivot_wider(id_cols= "subject",names_from = "trialcode", values_from = "response")
